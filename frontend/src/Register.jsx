...
import { useRegisterUserMutation } from '../src/query/Auth.query'; // Corrected this line
  ...
  return (
    <>
      ...
      <div className=' flex gap-1 justify-center bg-slate-50'>
              ...
              {({ handleSubmit }) => (
                <form onSubmit={handleSubmit} className="flex flex-col p-4 gap-5">
                  <div className="flex flex-col gap-1">
                    ...
                    <Field id='name' name='name' className="rounded-lg bg-slate-200 border-gray-500 py-5 px-2 outline-none h-8 md:w-[26vw]" placeholder='Enter name' />
        ...
        <div className='md:w-[45vw] md:h-[69vh] md:flex hidden'>
